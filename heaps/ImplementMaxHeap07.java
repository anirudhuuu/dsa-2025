 ...
 * - changeKey (ind, val) -> update the value at given index to val
 * (index will be given 0-based indexing)
 * - initializeHeap -> Initialize the heap
 */
public class ImplementMaxHeap07 {
    private static List<Integer> arr;
    private static int count;

    public ImplementMaxHeap07() {
        arr = new ArrayList<>();
        count = 0;
    }
    ...
    public static void changeKey(int index, int newVal) {
