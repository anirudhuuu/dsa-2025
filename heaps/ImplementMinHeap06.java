 ...
 */
public class ImplementMinHeap06 {
    private static List<Integer> arr;
    private static int count;

    public ImplementMinHeap06() {
        arr = new ArrayList<>();
        count = 0;
    }
    ...
    static void main() {
        ...
        arr.add(4);
        count++;
        new ImplementMinHeap06().heapifyUp(count - 1);
        ...
        // 5. getMin
        if (count > 0) {
            System.out.println("getMin: " + arr.get(0)); // 10
        } else {
            System.out.println("getMin: Heap is empty");
        }
        ...
        if (count > 0) {
            ...
            arr.remove(count - 1);
            count--;
            new ImplementMinHeap06().heapifyDown(0);
        }
        ...
        if (count > 0) {
            arr.set(0, 16);
            new ImplementMinHeap06().heapifyUp(0);
            new ImplementMinHeap06().heapifyDown(0);
        }
        ...
        // 10. getMin
        if (count > 0) {
            System.out.println("getMin: " + arr.get(0)); // 16
        } else {
            System.out.println("getMin: Heap is empty");
        }
    }
